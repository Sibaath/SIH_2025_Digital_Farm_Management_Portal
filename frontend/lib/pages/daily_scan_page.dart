...
// import 'dart:math';
// import 'summary_page.dart'; // Import the new page
...
//   // Dummy data set for autofilling the form
...
//   // The updated list of detailed responses you provided
...
//                       // Navigate to the SummaryPage on successful validation
//                       Navigator.push(
//                         context,
...
//       });
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Video recorded: ${video.path.split('/').last}')),
//       );
//     }
//   }
...
//       });
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Dummy video uploaded: ${video.path.split('/').last}')),
//       );
//     }
//   }
...
//                         const SizedBox(width: 10),
//                         Expanded(child: Text(_recordedVideoFile!.path.split('/').last)),
//                         IconButton(
