...
class Doctor {
  ...
  final String location;
  final double rating;
  final String phoneNumber; // CORRECTED: Added phoneNumber property
...
class _ContactsPageState extends State<ContactsPage> {
  // CORRECTED: Dummy data updated to include a phone number
  final List<Doctor> _availableDoctors = [
    Doctor(
      name: 'Dr. John Doe',
      specialization: 'Avian Biosecurity Expert',
  ...
  // New function to handle making a phone call
          ...
          children: [
            Row(
              ...
              children: [
                ...
                // ADDED: Call button for booked appointments
                IconButton(
                  icon: const Icon(Icons.phone, color: Colors.green),
                  onPressed: () => _makePhoneCall(appointment.doctor.phoneNumber),
                ),
              ],
            ),
            const SizedBox(height: 4),
